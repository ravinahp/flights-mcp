...
[![smithery badge](https://smithery.ai/badge/find-flights-mcp)](https://smithery.ai/server/find-flights-mcp)
...
To install Find Flights for Claude Desktop automatically via [Smithery](https://smithery.ai/server/find-flights-mcp):

```bash
npx -y @smithery/cli install find-flights-mcp --client claude
```
